    ...
    def update(self, rollouts, args):
        ...
        for e in range(self.ppo_epoch):
            ...
            for sample in data_generator:
                ...
                (value_loss * self.value_loss_coef + action_loss - self.entropy_coef * dist_entropy).backward()
                ...
                total_loss_epoch += value_loss * self.value_loss_coef + action_loss - self.entropy_coef * dist_entropy
